...
function App() {
  ...
  function handleButton(){
    ...
    var stringCpf:any = JSON.stringify(cpf);
    ...
    verificador2 = cpfSoma % 11;
      ...
      erro = 0;
        ...
        setCpfFormatado(
        arrayCpfNum[0]?.toString()+arrayCpfNum[1]?.toString()+arrayCpfNum[2]?.toString()+"."+
        arrayCpfNum[3]?.toString()+arrayCpfNum[4]?.toString()+arrayCpfNum[5]?.toString()+"."+
        arrayCpfNum[6]?.toString()+arrayCpfNum[7]?.toString()+arrayCpfNum[8]?.toString()+"-"+
        arrayCpfNum[9]?.toString()+arrayCpfNum[10]?.toString());
      }
      if (erro==1){
        setInvalido(1)
      } else if (erro==0){
  ...
  return (
    <>
      ...
      <div>
        {invalido==0?<p className='cpf-Formatado'>CPF:  {cpfFormatado}</p>:
        invalido == 1? null : null }
        <br></br>
        {invalido == 1?(<p>CPF inválido</p>):invalido==0?(<p>CPF válido</p>):invalido== undefined?null:null }
        <br></br>
